// 1c-gui-test-kit: хелперы для веб-сценариев (навык web-test).
//
...
// особенности веб-клиента 1С из docs/gotchas.md.
//
// До этого файла gui-test.ps1 объявляет:
//   FIXTURES_DIR - абсолютный путь к scenarios/_fixtures (прямые слэши)
